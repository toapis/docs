...
| --- | --- | --- |
| **Chat** | OpenAI-compatible completions, Anthropic Messages, OpenAI Responses, streaming, and vision input. GPT-5, Claude, DeepSeek, Gemini, Qwen, Kimi, GLM, MiniMax. | [API reference](https://docs.toapis.com/docs/en/api-reference/chat/chat) |
