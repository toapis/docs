...
| --- | --- | --- |
| **Chat** | OpenAI-compatible completions, Anthropic Messages, OpenAI Responses, streaming, and vision input. GPT-5.6, Claude Fable 5, Claude Opus 5, Claude Sonnet 5, Claude Haiku 4.5, Gemini 3.1 Pro, DeepSeek V3.2, GLM-5, Kimi K2.5, MiniMax M2.5, Qwen3.5 Plus, Qwen3.5 Flash. | [API reference](https://docs.toapis.com/docs/en/api-reference/chat/chat) |
