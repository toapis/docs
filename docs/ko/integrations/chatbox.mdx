...
### [​](#2-1-select-ai-model-provider)2.1 Select AI 모델 Provider
...
![Claude 모델](../../assets/images/en_integrations_chatbox/4ceb244f_claude.png)
...
### [​](#2-3-select-model)2.3 Select 모델

After configuration, select the model you want to use from the **모델** dropdown:
**Recommended 모델:**

| 모델 Name | 모델 ID | Features |
| --- | --- | --- |
...
**Special Instructions for Using Claude 모델:**If you choose to use Claude models (such as `claude-sonnet-4-5-20250929` or `claude-haiku-4-5-20251001`), you need the following additional configuration:
...
![모델 Selection](../../assets/images/en_integrations_chatbox/4efd7773_model-selection.png)
...
### [​](#adjust-model-parameters-optional)Adjust 모델 파라미터 (선택)

You can adjust the following parameters as needed:

| Parameter | 설명 | Recommended Value |
| --- | --- | --- |
...
### [​](#q3:-error-messages-during-conversation)Q3: 오류 messages during conversation?
...
| `500 Internal Server 오류` | Temporary server issue | Wait a few minutes and retry |
