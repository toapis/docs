...
1. On the provider config page, click **Add 모델**
2. Fill in the model details:
   - **모델 ID**: Enter the model ID you want to use (see recommended models below)
   - **엔드포인트 Type**: Select **OpenAI**
3. Click Save
...
| `500 Internal Server 오류` | Temporary server issue | Retry in a few minutes |
