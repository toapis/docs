---
title: "Get Image Task 상태"
sidebarTitle: "Get Image Task 상태"
...
<Note>ToAPIs 통합 [Task Webhook](/docs/ko/api-reference/webhooks/task-webhooks)을 우선 사용하고 조회는 대체 경로로 사용하세요. 5~10초 이상과 지터, `429`의 `Retry-After`를 따르세요. 배치는 최대 100개입니다. [속도 제한](/docs/ko/api-reference/rate-limits/async-tasks).</Note>
