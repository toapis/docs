---
title: "Claude Haiku 4-5 Chat"
sidebarTitle: "claude-haiku-4-5"
api: "POST https://toapis.com/v1/chat/completions"
description: "The fastest and most cost-efficient Claude model, ideal for high-throughput and latency-sensitive use cases"
---

- OpenAI-compatible Chat Completions API
- Select the `claude-haiku-4-5` model via the `model` parameter
