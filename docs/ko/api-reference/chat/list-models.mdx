---
title: "List 모델"
sidebarTitle: "List 모델"
api: "GET https://toapis.com/v1/models"
description: "List models available to the current API key, compatible with the OpenAI 모델 API"
---

- Compatible with the OpenAI 모델 API format
...
<ResponseField name="data" type="object[]">
  ...
  <Expandable title="data[n]">
    <ResponseField name="id" type="string">
      모델 ID. Use this value as the `model` parameter in other API requests.
    </ResponseField>
    ...
    <ResponseField name="created" type="integer">
      모델 creation timestamp. Some custom models may return the platform default timestamp.
    </ResponseField>

    <ResponseField name="owned_by" type="string">
      모델 owner, provider, or channel name.
    </ResponseField>

    <ResponseField name="supported_endpoint_types" type="string[]">
      엔드포인트 types supported by the model. Different models may support Chat Completions, 응답s, image, video, or other endpoints.
    </ResponseField>
  </Expandable>
</ResponseField>
