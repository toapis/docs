---
title: "Claude Sonnet 4-6 Chat"
sidebarTitle: "claude-sonnet-4-6"
api: "POST https://toapis.com/v1/chat/completions"
description: "The best balance of performance and cost in the Claude family, suitable for most business use cases"
---

- OpenAI-compatible Chat Completions API
- Select the `claude-sonnet-4-6` model via the `model` parameter
