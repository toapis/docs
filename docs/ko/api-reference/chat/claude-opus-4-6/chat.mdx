---
title: "Claude Opus 4-6 Chat"
sidebarTitle: "claude-opus-4-6"
api: "POST https://toapis.com/v1/chat/completions"
description: "The most powerful Claude model, designed for complex reasoning, deep analysis, and demanding tasks"
---

- OpenAI-compatible Chat Completions API
- Select the `claude-opus-4-6` model via the `model` parameter
