...
<ParamField body="prompt" type="string">
  ...
  필수 for text-to-video, reference-to-video, and video editing. 선택 for image-to-video, but recommended for motion and style control.
</ParamField>
...
<ParamField body="reference_images" type="string[]">
  ...
  필수 for `reference-to-video`, with `1` to `9` images. 선택 for `video-edit`, with up to `5` images.
</ParamField>

<ParamField body="url" type="string">
  Input video URL for video editing. 필수 when `action=video-edit`.
</ParamField>
