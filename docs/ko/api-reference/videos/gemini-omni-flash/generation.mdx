...
description: "비공식 Gemini Omni Flash 채널에서 텍스트 또는 최대 3개의 참조 이미지로 비디오 생성"
---
...
<Warning>
Upload local images with the [Upload 이미지 API](../../uploads/images) first, then pass the returned URLs in `image_urls`. Do not pass base64 image data directly.
</Warning>
