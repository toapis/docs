...
<ParamField body="prompt" type="string" required>
  ...
  필수 for text-to-video mode; optional for image-to-video and reference video modes (describe expected motion or style)
...
| Aspect Ratio | 설명 | 720p Size | 1080p Size |
|---|---|---|---|
...
<Note>
  **Querying Task Results**
  ...
  Video generation is an asynchronous task. After submission, a `task_id` is returned. Use the [Get Video Task 상태](../../tasks/video-status) interface to query generation progress and results.
</Note>
