...
<Warning>
**Important Change**: For better performance and cost control, we no longer support passing base64 image data directly in `image_urls`. Please use the [Upload 이미지 API](../../uploads/images) first to upload images and get URLs, then call this endpoint.
</Warning>
...
<ParamField body="image_urls" type="string[]">
  ...
  **⚠️ URL format only (base64 no longer supported)**
  ...
  - You can use the [Upload 이미지 API](../../uploads/images) to upload local images and get URLs
</ParamField>
