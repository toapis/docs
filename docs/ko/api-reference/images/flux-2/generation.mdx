...
Image generation is an async task. After submission, a task ID is returned. Use the [Get Image Task 상태](../../tasks/image-status) endpoint to query generation progress and results.
</Note>
