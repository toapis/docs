---
title: "Gemini-3-Pro Official 이미지 생성"
sidebarTitle: "Gemini-3-Pro-Image Official"
api: "POST https://toapis.com/v1/images/generations"
description: "Generate images using Google Gemini 3 Pro official direct-connect model with native parameter control"
---
...
<ParamField body="model" type="string" default="gemini-3-pro-image-preview-official" required>
  ...
  Example: `"gemini-3-pro-image-preview-official"`
</ParamField>
