---
title: "Gemini-3-Pro 이미지 생성"
sidebarTitle: "Gemini-3-Pro-Image"
api: "POST https://toapis.com/v1/images/generations"
description: "Generate images using Google Gemini 3 Pro model, with powerful image generation capabilities"
---
...
<ParamField body="prompt" type="string" required>
  ...
  The upstream model input limit is 65,536 tokens. ToAPIs does not add a 1000-character cap.
</ParamField>
