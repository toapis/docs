---
title: "ToAPIs — OpenAI-совместимый API-шлюз (GPT-5, Claude, Gemini)"
sidebarTitle: "ToAPIs — OpenAI-совместимый API-шлюз"
description: "OpenAI-совместимый API, поддержка GPT-5, Claude, Gemini. Маршрутизация между провайдерами, прозрачное ценообразование, низкая задержка. Корпоративный SLA, поддержка SDK, оплата по факту."
---
...
<Card title="Начать сейчас" icon="rocket" href="./ru/api-reference/chat/chat">
...
<CardGroup cols={3}>
  <Card title="Chat Completions API" icon="comments" href="./ru/api-reference/chat/chat">
    Поддержка стриминга и низкая задержка
  </Card>
  <Card title="API генерации изображений" icon="image" href="./ru/api-reference/images/gpt-4o/generation">
    GPT-4o-image, Seedream и другие модели
  </Card>
  <Card title="API генерации видео" icon="video" href="./ru/api-reference/videos/veo3/generation">
