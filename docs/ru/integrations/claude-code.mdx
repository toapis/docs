...
description: "Используйте ToAPIs в качестве бэкенда API для Claude Code"
---
...
| Переменная | Значение |
| --- | --- |
| **ANTHROPIC_AUTH_TOKEN** | Ваш API-ключ ToAPIs (`sk-xxxxxxxxxxxx`) |
| **ANTHROPIC_BASE_URL** | `https://toapis.com` |
...
Зарегистрируйтесь в ToAPIs, получите API-ключ и ускорьте разработку с Claude Code!](https://toapis.com)
