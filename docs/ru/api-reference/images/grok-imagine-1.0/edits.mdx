---
title: "Grok Imagine 1.0 Редактирование изображений"
sidebarTitle: "Edits"
api: "POST https://toapis.com/v1/images/edits"
description: "Асинхронное редактирование изображений с grok-imagine-1.0-edit на основе референсов"
---
...
<ParamField body="image_urls" type="string[]" required>
  ...
  При необходимости сначала загрузите изображение через [API загрузки изображений](../../uploads/images)
</ParamField>
