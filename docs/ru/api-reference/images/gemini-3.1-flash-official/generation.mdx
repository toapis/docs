---
title: "Gemini-3.1-Flash Official Генерация изображений"
sidebarTitle: "Gemini-3.1-Flash-Image Official"
api: "POST https://toapis.com/v1/images/generations"
description: "Генерация изображений с использованием модели Google Gemini 3.1 Flash с прямым подключением, поддержка режима мышления и экстремальных соотношений сторон"
---

- Прямое подключение к Google Vertex AI через нативный API Gemini 3.1 Flash Image
- Выбор модели `gemini-3.1-flash-image-preview-official` через параметр model
- Nano Banana 2 aliases: `nano-banana-2-lite-official` and `nano-banana-2-official`
...
- Поддержка экстремальных соотношений сторон (4:1, 8:1)
...
<ParamField body="model" type="string" default="gemini-3.1-flash-image-preview-official" required>
  ...
  Пример: `"gemini-3.1-flash-image-preview-official"`
</ParamField>
...
<ParamField body="size" type="string">
  ...
  - `9:16` / `16:9`
  - `21:9`
  - `4:1` / `8:1` - Экстремальные широкоэкранные пропорции
</ParamField>
...
<ParamField body="image_urls" type="string[]">
  ...
  **⚠️ Поддерживается только формат URL (base64 больше не поддерживается)**
  ...
  - Используйте [эндпоинт загрузки изображений](../../uploads/images) для загрузки локальных изображений
...
<ParamField body="metadata" type="object">
  ...
  <Expandable title="Показать поля metadata">
    <ParamField body="temperature" type="number">
      ...
      Диапазон: `0.0` - `2.0`, по умолчанию `1.0`
    </ParamField>
...
curl --request POST \
  ...
  --data '{
    ...
    "prompt": "Картина тушью в стиле китайской живописи: горы и реки, многослойные вершины в клубах тумана",
    "size": "16:9",
    "n": 1,
    "metadata": {
      "temperature": 1.0,
