...
description: "Генерация изображений с помощью модели Google Gemini 3 Pro"
---
...
<ParamField body="prompt" type="string" required>
  ...
  Лимит входа upstream-модели: 65 536 токенов. ToAPIs не добавляет ограничение в 1000 символов.
</ParamField>
