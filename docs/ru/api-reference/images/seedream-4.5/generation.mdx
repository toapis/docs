---
title: "Seedream-4.5 Генерация изображений"
sidebarTitle: "Seedream-4.5"
api: "POST https://toapis.com/v1/images/generations"
description: "Генерация высококачественных изображений с помощью модели Seedream 4.5"
---
...
```bash cURL (Изображение-в-изображение)
curl --request POST \
  --url https://toapis.com/v1/images/generations \
  --header 'Authorization: Bearer <token>' \
  --header 'Content-Type: application/json' \
...
```python Python (Изображение-в-изображение)
import requests
...
```python Python (Расширенные функции)
import requests
...
```javascript JavaScript (Изображение-в-изображение)
const response = await fetch('https://toapis.com/v1/images/generations', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer your-ToAPIs-key',
...
```javascript JavaScript (Расширенные функции)
const response = await fetch('https://toapis.com/v1/images/generations', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer your-ToAPIs-key',
