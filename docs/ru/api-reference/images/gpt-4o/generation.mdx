---
title: "GPT-4o Генерация изображений"
sidebarTitle: "GPT-4o-image"
api: "POST https://toapis.com/v1/images/generations"
description: "Генерация изображений с помощью модели GPT-4o, поддержка текст-в-изображение и редактирования"
---
...
```bash cURL (Редактирование изображения)
curl --request POST \
  --url https://toapis.com/v1/images/generations \
  --header 'Authorization: Bearer <token>' \
  --header 'Content-Type: application/json' \
