---
title: "Генерация изображений Flux Kontext"
sidebarTitle: "Flux Kontext"
api: "POST https://toapis.com/v1/images/generations"
description: "Генерация и редактирование изображений с помощью модели Flux Kontext, поддержка текст-в-изображение и редактирование изображений"
---
