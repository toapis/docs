---
title: "Seedream-5.0 Генерация изображений"
sidebarTitle: "Seedream-5.0"
api: "POST https://toapis.com/v1/images/generations"
description: "Генерация высококачественных изображений с помощью модели Seedream 5.0 lite с поддержкой 2K/3K и поиском в интернете"
---
...
<ParamField body="image_urls" type="string[]">
  ...
  **⚠️ Только формат URL (base64 больше не поддерживается)**
  ...
  - Используйте [API загрузки изображений](../../uploads/images) для загрузки локальных файлов
