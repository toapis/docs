---
title: "Gemini-2.5-Flash Official Генерация изображений"
sidebarTitle: "Gemini-2.5-Flash-Image Official"
api: "POST https://toapis.com/v1/images/generations"
description: "Генерация изображений с использованием модели Google Gemini 2.5 Flash с прямым подключением, быстро и эффективно"
---
...
<ParamField body="model" type="string" default="gemini-2.5-flash-image-official" required>
  ...
  Пример: `"gemini-2.5-flash-image-official"`
</ParamField>
