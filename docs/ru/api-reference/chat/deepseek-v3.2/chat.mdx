---
title: "Чат DeepSeek-V3.2"
sidebarTitle: "deepseek-v3.2"
api: "POST https://toapis.com/v1/chat/completions"
description: "Флагманская модель DeepSeek с комплексными возможностями, сопоставимыми с GPT-4.5, превосходящая в коде и математике"
---

- Совместимый с OpenAI API чат-завершений
- Выберите модель `deepseek-v3.2` через параметр `model`
- Поддержка потоковой передачи (SSE)
- Поддержка многоходовых диалогов, системных промптов, генерации кода и математических рассуждений
...
<ParamField body="model" type="string" default="deepseek-v3.2" required>
  Название модели

  Пример: `"deepseek-v3.2"`
</ParamField>
...
<ParamField body="messages" type="object[]" required>
  ...
  <Expandable title="messages[n]">
    ...
    <ParamField body="content" type="string" required>
      Содержимое — строка или массив блоков контента (поддерживает изображения)
    </ParamField>
  </Expandable>
</ParamField>
  ...
  "choices": [
    {
      ...
      "message": {
        "role": "assistant",
        "content": "Привет! Я DeepSeek, ИИ-ассистент от компании DeepSeek. Я отлично справляюсь с генерацией кода, математическими рассуждениями, логическим анализом и пониманием естественного языка. Чем могу помочь?"
      },
      "finish_reason": "stop"
    }
  ],
