---
title: "Чат Claude Opus 4-6"
sidebarTitle: "claude-opus-4-6"
api: "POST https://toapis.com/v1/chat/completions"
description: "Самая мощная модель Claude для сложных рассуждений, глубокого анализа и требовательных задач"
---

- Совместимый с OpenAI API чат-завершений
- Выберите модель `claude-opus-4-6` через параметр `model`
