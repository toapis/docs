---
title: "Чат Claude Haiku 4-5"
sidebarTitle: "claude-haiku-4-5"
api: "POST https://toapis.com/v1/chat/completions"
description: "Самая быстрая и экономичная модель Claude, идеальна для высоконагруженных сценариев с низкой задержкой"
---

- Совместимый с OpenAI API чат-завершений
- Выберите модель `claude-haiku-4-5` через параметр `model`
