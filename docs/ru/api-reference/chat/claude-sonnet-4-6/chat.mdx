---
title: "Чат Claude Sonnet 4-6"
sidebarTitle: "claude-sonnet-4-6"
api: "POST https://toapis.com/v1/chat/completions"
description: "Оптимальный баланс производительности и стоимости в семействе Claude, подходит для большинства бизнес-задач"
---

- Совместимый с OpenAI API чат-завершений
- Выберите модель `claude-sonnet-4-6` через параметр `model`
- Поддержка потоковой передачи (SSE)
- Поддержка многоходовых диалогов, системных промптов и визуального ввода
