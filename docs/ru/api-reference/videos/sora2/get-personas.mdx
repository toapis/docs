---
title: "Sora2 Запрос статуса персонажа"
sidebarTitle: "Запрос статуса персонажа"
api: "GET https://toapis.com/v1/characters_tasks/{task_id}"
description: "Запрос статуса задачи создания персонажа и результатов"
---
...
<ParamField path="task_id" type="string" required>
  ...
  Это ID задачи, возвращённый из API [Создание персонажа](./create-persona)
