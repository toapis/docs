---
title: "Wan2.6 Генерация видео"
sidebarTitle: "Wan2.6"
api: "POST https://toapis.com/v1/videos/generations"
description: "Генерация высококачественных видео с помощью модели Alibaba Cloud Wan2.6 — поддержка текст-в-видео, изображение-в-видео и референсного видео"
---
...
<Note>
  **Получение результатов задачи**
  ...
  Генерация видео — асинхронная задача. После отправки возвращается `task_id`. Используйте интерфейс [Получить статус видео](../../tasks/video-status) для запроса прогресса и результатов.
</Note>
