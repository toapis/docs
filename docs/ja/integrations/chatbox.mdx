...
### [​](#2-1-select-ai-model-provider)2.1 Select AI モデル Provider
...
![Claude モデル](../../assets/images/en_integrations_chatbox/4ceb244f_claude.png)
...
### [​](#2-3-select-model)2.3 Select モデル

After configuration, select the model you want to use from the **モデル** dropdown:
**Recommended モデル:**

| モデル Name | モデル ID | Features |
| --- | --- | --- |
...
**Special Instructions for Using Claude モデル:**If you choose to use Claude models (such as `claude-sonnet-4-5-20250929` or `claude-haiku-4-5-20251001`), you need the following additional configuration:
...
![モデル Selection](../../assets/images/en_integrations_chatbox/4efd7773_model-selection.png)
...
### [​](#adjust-model-parameters-optional)Adjust モデル パラメータ (任意)

You can adjust the following parameters as needed:

| Parameter | 説明 | Recommended Value |
| --- | --- | --- |
...
### [​](#q3:-error-messages-during-conversation)Q3: エラー messages during conversation?
...
| `500 Internal Server エラー` | Temporary server issue | Wait a few minutes and retry |
