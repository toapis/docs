---
title: "Cherry Studio 設定ガイド"
sidebarTitle: "Cherry Studio"
description: "Use ToAPIs as the API backend for Cherry Studio"
---
...
1. On the provider config page, click **Add モデル**
2. Fill in the model details:
   - **モデル ID**: Enter the model ID you want to use (see recommended models below)
   - **エンドポイント Type**: Select **OpenAI**
3. Click Save
...
| モデル Name | モデル ID | 説明 |
| --- | --- | --- |
| Claude Opus 4.6 | [`claude-opus-4-6`](../api-reference/chat/claude-opus-4-6/chat) | Most capable, best for complex tasks |
| Claude Sonnet 4.6 | [`claude-sonnet-4-6`](../api-reference/chat/claude-sonnet-4-6/chat) | Balanced performance and speed — recommended for daily use |
| Claude Haiku 4.5 | [`claude-haiku-4-5-20251001`](../api-reference/chat/claude-haiku-4-5/chat) | Fastest, best for lightweight tasks |
| GPT-5 | [`gpt-5`](../api-reference/chat/models) | Latest OpenAI flagship model |
| GPT-4o | [`gpt-4o`](../api-reference/chat/models) | High-quality conversations and multimodal |
| GPT-4o Mini | [`gpt-4o-mini`](../api-reference/chat/models) | Fast and cost-effective |
| Gemini 2.5 Pro | [`gemini-2.5-pro`](../api-reference/chat/models) | Google multimodal flagship |
...
| `500 Internal Server エラー` | Temporary server issue | Retry in a few minutes |
...
Sign up for ToAPIs, get your API key, and supercharge your AI workflow with Cherry Studio!](https://toapis.com)
