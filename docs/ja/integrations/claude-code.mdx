...
description: "Use ToAPIs as the API backend for Claude Code"
---
...
| Variable | Value |
| --- | --- |
| **ANTHROPIC_AUTH_TOKEN** | Your ToAPIs API key (`sk-xxxxxxxxxxxx`) |
| **ANTHROPIC_BASE_URL** | `https://toapis.com` |
...
Sign up for ToAPIs, get your API key, and supercharge your coding with Claude Code!](https://toapis.com)
