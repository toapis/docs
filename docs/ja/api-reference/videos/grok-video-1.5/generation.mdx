...
<Warning>
Do not pass base64 image data. Upload local files with the [Upload 画像API](../../uploads/images), then pass the returned public URL in `image`.
</Warning>
...
Use the returned `id` with [Video Task ステータス](../../tasks/video-status).
