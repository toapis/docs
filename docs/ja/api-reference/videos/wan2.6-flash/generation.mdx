---
title: "Wan2.6 Flash 動画生成"
sidebarTitle: "Wan2.6 Flash"
api: "POST https://toapis.com/v1/videos/generations"
description: "Generate videos using Alibaba Cloud Wan2.6 Flash model — faster image-to-video and reference video generation"
---
...
<ParamField body="image_urls" type="string[]">
  ...
  **必須 if `metadata.reference_urls` is not provided**
