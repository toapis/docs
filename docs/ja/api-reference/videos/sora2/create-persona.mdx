...
sidebarTitle: "Create Character"
api: "POST https://toapis.com/v1/videos/generations"
description: "Extract characters from video for subsequent video generation"
---
...
```json 200 (Completed - Query Result)
{
...
<Steps>
  ...
  <Step title="Query Task ステータス">
    Use the [Query Video Task ステータス](../../tasks/video-status) API to poll task progress
  </Step>
  <Step title="Use Character in 動画生成">
