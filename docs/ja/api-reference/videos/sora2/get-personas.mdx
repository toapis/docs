---
title: "Sora2 Query Character ステータス"
sidebarTitle: "Query Character ステータス"
api: "GET https://toapis.com/v1/characters_tasks/{task_id}"
description: "Query character creation task status and results"
---
...
<ParamField path="task_id" type="string" required>
  ...
  This is the task ID returned from the [Create Character](./create-persona) API
...
<ResponseField name="error" type="object">
  エラー information (only available when status is failed)
</ResponseField>
