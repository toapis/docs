---
title: "レスポンスs API"
sidebarTitle: "レスポンスs API"
api: "POST https://toapis.com/v1/responses"
description: "OpenAI レスポンスs API format with function calling, built-in tools, and server-side multi-turn context"
---
...
<Warning>
モデル marked as **レスポンスs Only**, such as `gpt-5-pro-official` and `gpt-5.3-codex-official`, only support this API and do not support Chat Completions. See the [model list](./models) for details.
</Warning>
