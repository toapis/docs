...
<ParamField body="image_urls" type="string[]">
  ...
  **⚠️ URL format only (base64 not supported)**
  ...
  - Use the [Upload 画像API](../../uploads/images) to upload local images and get URLs
...
Image generation is an async task. After submission, a task ID is returned. Use the [Get Image Task ステータス](../../tasks/image-status) endpoint to query generation progress and results.
</Note>
