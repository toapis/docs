---
title: "Grok Imagine 1.0 Image Editing"
sidebarTitle: "Edits"
api: "POST https://toapis.com/v1/images/edits"
description: "Async image editing with grok-imagine-1.0-edit based on reference images"
---
...
<ParamField body="image_urls" type="string[]" required>
  ...
  You can upload first via [Upload Image API](../../uploads/images)
</ParamField>
