...
description: "Generate and edit images using Flux Kontext model, supporting text-to-image and image editing"
---
...
```javascript JavaScript (Image Editing)
const response = await fetch('https://toapis.com/v1/images/generations', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer your-ToAPIs-key',
