...
description: "Generate high-quality images using Seedream 4.0 model"
---
...
<ParamField body="metadata" type="object">
  ...
  <Expandable title="metadata properties">
    ...
    <ParamField body="metadata.optimize_prompt_options" type="object">
      ...
      **Properties:**
      - `mode` (string): Optimization mode
        - `standard`: Standard mode, generates higher quality with longer processing time (default)
    ...
    <ParamField body="metadata.sequential_image_generation" type="string" default="disabled">
      ...
      - `disabled`: Disable sequential mode, generates only 1 image (default)
