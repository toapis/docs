...
sidebarTitle: "Seedream-4.5"
api: "POST https://toapis.com/v1/images/generations"
description: "Generate high-quality images using Seedream 4.5 model, latest version"
---
...
```javascript JavaScript (Advanced Features)
const response = await fetch('https://toapis.com/v1/images/generations', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer your-ToAPIs-key',
