...
<Warning>
**Important Change**: For better performance and cost control, we no longer support passing base64 image data directly in `reference_images`. Please use the [Upload Image API](../../uploads/images) to upload images first, then call this API with the returned URL.
</Warning>
