...
<Warning>
Please provide publicly accessible image URLs. Do not pass base64 image data directly in `image_urls`; upload local images first using the [Upload Image API](../../uploads/images) to get URLs.
</Warning>
