...
description: "Generate videos with Kling v3 Omni using official Omni references: image_list, video_list, and element_list"
---
...
<Warning>
Use publicly accessible image or video URLs. Do not pass base64 media data. Upload local images with the [Upload Image API](../../uploads/images) first.
</Warning>
