...
description: "DeepSeek's flagship model with comprehensive capabilities on par with GPT-4.5, excelling at code and math"
---

- OpenAI-compatible Chat Completions API
- Select the `deepseek-v3.2` model via the `model` parameter
- Supports streaming output (SSE)
- Supports multi-turn conversation, system prompts, code generation and mathematical reasoning
...
<ParamField body="messages" type="object[]" required>
  ...
  <Expandable title="messages[n]">
    ...
    <ParamField body="content" type="string" required>
      Message content — string or array of content blocks (supports images)
    </ParamField>
  </Expandable>
</ParamField>
  ...
  "choices": [
    {
      ...
      "message": {
        "role": "assistant",
        "content": "Hello! I'm DeepSeek, an AI assistant developed by DeepSeek. I excel at code generation, mathematical reasoning, logical analysis, and natural language understanding. How can I help you today?"
      },
      "finish_reason": "stop"
    }
  ],
