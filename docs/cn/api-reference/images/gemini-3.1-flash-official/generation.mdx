---
title: "Gemini-3.1-Flash Official 图像生成"
sidebarTitle: "Gemini-3.1-Flash-Image Official"
api: "POST https://toapis.com/v1/images/generations"
description: "使用 Google Gemini 3.1 Flash 官方直连模型生成图像，支持思考模式与极端宽高比"
---

- 直连 Google Vertex AI，使用 Gemini 3.1 Flash Image 原生 API
- 通过 model 参数选择 `gemini-3.1-flash-image-preview-official` 模型
