...
| `gpt-5.5` | GPT-5.5，更强的通用推理、代码与多模态能力 | ✓ | |
| `gpt-5.6-sol` | GPT-5.6 旗舰模型，适合复杂推理、高价值代码和长上下文任务 | ✓ | ✓ |
| `gpt-5.6-terra` | GPT-5.6 均衡模型，适合通用生产流量与 Agent 工作流 | ✓ | ✓ |
| `gpt-5.6-luna` | GPT-5.6 高吞吐模型，适合分类、抽取、路由和批处理 | ✓ | ✓ |
