---
title: "DeepSeek-V3.2 对话"
sidebarTitle: "deepseek-v3.2"
api: "POST https://toapis.com/v1/chat/completions"
description: "深度求索旗舰推理模型，综合能力全面对标 GPT-4.5，代码与数学表现卓越"
---

- 兼容 OpenAI Chat Completions API 格式
- 通过 `model` 参数指定 `deepseek-v3.2` 模型
- 支持流式输出（SSE）
- 支持多轮对话、系统提示词、代码生成与数学推理
- 仅支持文本输入，不支持视觉输入（图片）
  ...
  "choices": [
    {
      ...
      "message": {
        "role": "assistant",
        "content": "你好！我是 DeepSeek，一个由深度求索公司开发的 AI 助手。我擅长代码编写、数学推理、逻辑分析和自然语言理解。有什么我可以帮你的吗？"
      },
      "finish_reason": "stop"
    }
  ],
