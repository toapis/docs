---
title: "Qwen3.5 Flash 对话"
sidebarTitle: "qwen3.5-flash"
api: "POST https://toapis.com/v1/chat/completions"
description: "阿里千问极速轻量模型，极低成本，适合高并发、实时交互场景"
---

- 兼容 OpenAI Chat Completions API 格式
- 通过 `model` 参数指定 `qwen3.5-flash` 模型
- 支持流式输出（SSE）
- 支持多轮对话、系统提示词
- 超低延迟，适合实时客服、内容过滤、简单问答等场景
  ...
  "choices": [
    {
      ...
      "message": {
        "role": "assistant",
        "content": "机器学习是一种让计算机通过从数据中自动学习规律和模式，从而在无需明确编程的情况下完成特定任务的人工智能技术。"
      },
      "finish_reason": "stop"
    }
  ],
