---
title: "MiniMax M2.5 对话"
sidebarTitle: "MiniMax-M2.5"
api: "POST https://toapis.com/v1/chat/completions"
description: "MiniMax 新一代旗舰大语言模型，强大的推理与创作能力"
---

- 兼容 OpenAI Chat Completions API 格式
- 通过 `model` 参数指定 `MiniMax-M2.5` 模型
- 支持流式输出（SSE）
- 支持多轮对话、系统提示词
- 仅支持文本输入，不支持视觉输入（图片）
  ...
  "choices": [
    {
      ...
      "message": {
        "role": "assistant",
        "content": "你好！我是 MiniMax M2.5，由 MiniMax 开发的新一代大语言模型。我具备强大的推理和创作能力，可以帮助你完成各类对话、写作、分析等任务。有什么可以帮到你？"
      },
      "finish_reason": "stop"
    }
  ],
