...
sidebarTitle: "ToAPIs — OpenAI 兼容 API 网关"
...
<Card title="立即开始" icon="rocket" href="./cn/api-reference/chat/chat">
...
<CardGroup cols={3}>
  <Card title="聊天补全 API" icon="comments" href="./cn/api-reference/chat/chat">
    流式支持和低延迟
  </Card>
...
<Card title="查看视频状态 →" href="./cn/api-reference/tasks/video-status" />
