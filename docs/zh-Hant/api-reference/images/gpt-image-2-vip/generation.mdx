---
title: "GPT-Image-2-VIP 圖像生成"
sidebarTitle: "gpt-image-2-vip"
api: "POST https://toapis.com/v1/images/generations"
description: "使用 gpt-image-2-vip 模型生成圖像，參數與 gpt-image-2 一致，但支持全部常用寬高比"
---

- 統一的圖像生成 API 接口
- 通過 `model` 參數選擇 `gpt-image-2-vip`
- 參數與 `gpt-image-2` 保持一致
- 支持文生圖、單圖參考和多圖參考生成
- 異步任務管理，通過任務 ID 查詢結果
...
<ParamField body="callback_url" type="string">
  ToAPIs 標準任務完成回調。需先設定 Token HTTPS URL 與密鑰，且只能同源覆蓋。詳見 [Webhook](/docs/zh-Hant/api-reference/webhooks/task-webhooks)。
</ParamField>
...
curl --request POST \
  ...
  --data '{
    ...
    "prompt": "生成一張橫版電影海報，未來城市夜景，霓虹燈，電影感構圖",
    "n": 1,
    "size": "16:9",
    "resolution": "2k",
    "quality": "high",
