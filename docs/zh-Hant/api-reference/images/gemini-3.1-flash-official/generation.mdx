---
title: "Gemini-3.1-Flash Official 圖像生成"
sidebarTitle: "Gemini-3.1-Flash-Image Official"
api: "POST https://toapis.com/v1/images/generations"
description: "使用 Google Gemini 3.1 Flash 官方直連模型生成圖像，支持思考模式與極端寬高比"
---

- 直連 Google Vertex AI，使用 Gemini 3.1 Flash Image 原生 API
- 通過 model 參數選擇 `gemini-3.1-flash-image-preview-official` 模型
...
<ParamField body="model" type="string" default="gemini-3.1-flash-image-preview-official" required>
  ...
  示例：`"gemini-3.1-flash-image-preview-official"`
</ParamField>
