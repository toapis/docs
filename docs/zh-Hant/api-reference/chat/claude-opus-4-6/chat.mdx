---
title: "Claude Opus 4-6 對話"
sidebarTitle: "claude-opus-4-6"
api: "POST https://toapis.com/v1/chat/completions"
description: "最強大的 Claude 模型，適合複雜推理、深度分析等高要求場景"
---

- 兼容 OpenAI Chat Completions API 格式
- 通過 `model` 參數指定 `claude-opus-4-6` 模型
- 支持流式輸出（SSE）
- 支持多輪對話、系統提示詞、視覺輸入
...
<ParamField body="model" type="string" default="claude-opus-4-6" required>
  模型名稱
