---
title: "Claude Haiku 4-5 對話"
sidebarTitle: "claude-haiku-4-5"
api: "POST https://toapis.com/v1/chat/completions"
description: "速度最快、成本最低的 Claude 模型，適合高併發、延遲敏感場景"
---

- 兼容 OpenAI Chat Completions API 格式
- 通過 `model` 參數指定 `claude-haiku-4-5` 模型
- 支持流式輸出（SSE）
- 支持多輪對話、系統提示詞、視覺輸入
...
<ParamField body="model" type="string" default="claude-haiku-4-5" required>
  模型名稱
