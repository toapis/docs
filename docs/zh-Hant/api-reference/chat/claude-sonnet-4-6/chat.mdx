---
title: "Claude Sonnet 4-6 對話"
sidebarTitle: "claude-sonnet-4-6"
api: "POST https://toapis.com/v1/chat/completions"
description: "性能與成本最佳平衡的 Claude 模型，適合大多數業務場景"
---

- 兼容 OpenAI Chat Completions API 格式
- 通過 `model` 參數指定 `claude-sonnet-4-6` 模型
- 支持流式輸出（SSE）
- 支持多輪對話、系統提示詞、視覺輸入
...
<ParamField body="model" type="string" default="claude-sonnet-4-6" required>
  模型名稱
